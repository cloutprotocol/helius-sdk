...
import { CreateSmartTransactionOptions, GetPriorityFeeEstimateRequest, GetPriorityFeeEstimateResponse, GetProgramAccountsV2Options, GetProgramAccountsV2Response, GetTokenAccountsByOwnerV2Filter, GetTokenAccountsByOwnerV2Options, GetTokenAccountsByOwnerV2Response, HeliusSendOptions, JitoRegion, JupiterSwapParams, JupiterSwapResult, PollTransactionOptions, SendSmartTransactionOptions, SignedTransactionInput, SmartTransactionContext } from './types';
...
export declare class RpcClient {
     ...
     * ```
     */
    getProgramAccountsV2<T = any>(programId: string, options?: GetProgramAccountsV2Options): Promise<GetProgramAccountsV2Response<T>>;
    /**
     ...
     * ```
     */
    getAllProgramAccounts<T = any>(programId: string, options?: Omit<GetProgramAccountsV2Options, 'paginationKey' | 'limit'>): Promise<Array<{
        pubkey: string;
        account: any;
    }>>;
    /**
     ...
     * ```
     */
    getTokenAccountsByOwnerV2<T = any>(ownerAddress: string, filter: GetTokenAccountsByOwnerV2Filter, options?: GetTokenAccountsByOwnerV2Options): Promise<GetTokenAccountsByOwnerV2Response<T>>;
    /**
     ...
     * ```
     */
    getAllTokenAccountsByOwner<T = any>(ownerAddress: string, filter: GetTokenAccountsByOwnerV2Filter, options?: Omit<GetTokenAccountsByOwnerV2Options, 'paginationKey' | 'limit'>): Promise<Array<{
        pubkey: string;
        account: any;
    }>>;
    /**
