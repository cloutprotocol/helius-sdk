    ...
    _editWebhook(webhookID, existingWebhook, editWebhookRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = {
                ...
                accountAddressOwners: (_e = (_d = editWebhookRequest.accountAddressOwners) !== null && _d !== void 0 ? _d : existingWebhook.accountAddressOwners) !== null && _e !== void 0 ? _e : [],
                webhookType: (_f = editWebhookRequest.webhookType) !== null && _f !== void 0 ? _f : existingWebhook.webhookType,
                authHeader: (_h = (_g = editWebhookRequest.authHeader) !== null && _g !== void 0 ? _g : existingWebhook.authHeader) !== null && _h !== void 0 ? _h : '',
                txnStatus: (_j = editWebhookRequest.txnStatus) !== null && _j !== void 0 ? _j : existingWebhook.txnStatus,
                encoding: (_k = editWebhookRequest.encoding) !== null && _k !== void 0 ? _k : existingWebhook.encoding,
            };
            Object.keys(body).forEach((k) => body[k] === undefined && delete body[k]);
            try {
                const { data } = yield axios_1.default.put(this.getWebhookApiEndpoint(`/v0/webhooks/${webhookID}`), body, { headers: { 'Content-Type': 'application/json' } });
                return data;
            }
            catch (err) {
                if (axios_1.default.isAxiosError(err)) {
                    const error = typeof ((_l = err.response) === null || _l === void 0 ? void 0 : _l.data) === 'string'
                        ? err.response.data
                        : JSON.stringify((_m = err.response) === null || _m === void 0 ? void 0 : _m.data);
